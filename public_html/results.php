...
<?php
function print_table($solve_type, $name) {
?>
  <h2><?= $name ?></h2>
...
print_table('field', 'Static area');
print_table('dfield', 'Dynamic area');
print_table('sfield', 'Static area with specified nodes and growing radius');
print_table('sfield_fr', 'Static area with specified nodes');
?>
